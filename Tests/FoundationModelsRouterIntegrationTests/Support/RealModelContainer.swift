...
/// The one way every gated suite in this target puts a real model into its
...
enum RealModelContainer {
    ...
    ///     ``RealModels/context``, the budget this target's gated suites
