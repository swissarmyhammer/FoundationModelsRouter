...
actor CountingBlankSlateSummarizer: CompactionSummarizer {
...
/// The one way a fast compaction suite in this target folds a transcript it
...
enum CompactionFold {
    ...
    static func budget(forcingSummarizationOf transcript: Transcript) -> TokenBudget {
    ...
    ///   ``Compactor``'s did-not-shrink guard measures.
    static func foldedSpanTokens(of transcript: Transcript, keepRecentTurns: Int) -> Int {
