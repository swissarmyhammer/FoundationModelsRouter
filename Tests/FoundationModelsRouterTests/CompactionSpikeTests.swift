...
/// `IntegrationTests/Tests/FoundationModelsRouterIntegrationTests/` (`swift test --package-path IntegrationTests`)
...
struct CompactionSpikeTests {
    ...
    /// read further serialized by the owning session's pump.
