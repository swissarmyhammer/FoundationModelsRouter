...
///   (Qwen2.5-3B-Instruct), minus one task of margin; they are not derived again on
...
/// 2026-08-21 with the subject of that time, Qwen2.5-3B-Instruct, already in the Hugging
